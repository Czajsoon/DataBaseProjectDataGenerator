...
public class Generator {
    ...
    public final String Plec[] = {"Kobieta","Mężczyzna"};

    public final String m_imiona[] = {"Adam","Adrian","Adolf","Albert","Aleksander","Alex","Allan","Amadeusz","Amir","Artur","Bartosz"
    ...
    public final String d_imiona[] = {"Ada","Adela","Agata","Agnieszka","Aleksandra","Alicja","Amelia","Aneta","Angela","Anna","Apolina","Armanda"
    ...
    public final String m_nazwiska[] = {"Adamecki","Araszkiewicz","Alexandrowicz","Bagiński","Betliński","Białecki","Bieliński","Biernacki","Bielecki"
    ...
    public final String d_nazwiska[] = {"Adamecka","Araszkiewicz","Alexandrowicz","Bagińska","Betlińska","Białecka","Bielińska","Biernacka","Bielecka"
